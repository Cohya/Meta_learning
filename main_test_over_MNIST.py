...
best_init_weights = fomaml.train(iterations = 35,
...
# for i in range(50):
#     if problem =='MNIST':
#         task = load_spesific_task_mnist([6,7,8,9])# Mnist
#     elif problem == 'cfar10':
#         task = load_spesific_task_cfar10([6,7,8,9])
...
#     loss_train_vec, loss_test_vec= net.train(X_train = X_train[:128],
#               Y_train = Y_train[:128],
#               X_test = X_test[:128], 
#               Y_test = Y_test[:128],
#               batch_sz = 10,
#               epochs = 10) # was 128 for the test 
...
#     loss_train_vec_fomaml, loss_test_vec_fomaml = net2.train(X_train = X_train[:128],
#               Y_train = Y_train[:128],
#               X_test = X_test[:128], 
#               Y_test = Y_test[:128],
#               batch_sz = 10,
